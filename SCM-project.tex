...
Our project is going to uncover the benefits of SCM for a company that has already survived some time without proper SCM. The purpose of the project is to introduce SCM to a company in a way that increases its productivity.
...
\section{Hypothesis}
Har vi någon hypotes? Annars tar vi bort den tycker jag!
